...
namespace Zephyr.Utils
{
    public class ValidateHelper
    {
        ...
        {
            int userNameLength = ValidateHelper.GetStringLength(userName);
        ...
        {
            Match i = ValidateHelper.RegNumber.Match(inputData);
            return i.Success;
        }

        public static bool IsNumberSign(string inputData)
        {
            Match i = ValidateHelper.RegNumberSign.Match(inputData);
            return i.Success;
        }

        public static bool IsDecimal(string inputData)
        {
            Match i = ValidateHelper.RegDecimal.Match(inputData);
            return i.Success;
        }

        public static bool IsDecimalSign(string inputData)
        {
            Match i = ValidateHelper.RegDecimalSign.Match(inputData);
            return i.Success;
        }

        public static bool IsHasCHZN(string inputData)
        {
            Match i = ValidateHelper.RegCHZN.Match(inputData);
            return i.Success;
        }
        ...
        {
            Match i = ValidateHelper.RegEmail.Match(inputData);
            return i.Success;
        }
