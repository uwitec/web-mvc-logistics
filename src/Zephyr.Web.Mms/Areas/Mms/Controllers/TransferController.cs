...
<settings>
    ...
    <where>
        ...
        <c column='E.MerchantsName'     symbol='like'     ignore='empty' values='{ReceiveUnitName}'      ></c>
        <c column='A.WarehouseCode'     symbol='equal'    ignore='empty' values='{WarehouseCode}'     ></c>
        <c column='A.PriceKind'         symbol='equal'    ignore='empty' values='{PriceKind}'     ></c>
        <c column='TransferDate'        symbol='daterange' ignore='empty' ></c>
    </where>
