...
function viewModel(data) {
    ...
    this.saveClick = function (a, b, c, d) {
        ...
        post.tabs[0] = self.gridEdit.getChanges(['ProjectCode', 'BuildPartCode', 'BuildPartName', 'ParentCode', 'PartAttr', 'NodeControl', 'ActualBeginTime', 'ActualEndTime', 'ImagePart', 'Remark']);
