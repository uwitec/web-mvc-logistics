...
trade.com.getCurrentProject = function () {
    return window!=parent?parent.$.cookie('CurrentProject'):"";
};

trade.com.formatSrcBillType = function (value) {
    var dict = {
        'trailer': '内贸订单'
    };
...
trade.com.bindCalcTotalMoney = function (self, fieldNum, fieldUnitPrice, fieldRowTotal, fieldAllTotal) {
...
trade.com.calcTotalMoneyWhileRemoveRow = function (self, fieldRowTotal, fieldAllTotal) {
...
trade.com.auditDialog = function () {
    var query = parent.$;
        ...
        var html = utils.functionComment(function () {/*
            <div id="w_audit_wrapper">
                <div id="w_audit_div" class="easyui-dialog"  title="审核" data-options="modal:true,closed:true,iconCls:'icon-user-accept'" style="width:400px;height:210px;" buttons="#w_audit_div_button"> 
                    <div class="container_16" style="width:90%;margin:5% 5% 0 5%;">  
...
//弹出选择材料窗口
trade.com.selectMaterial = function (vm, param) {
    var grid = vm.grid;
