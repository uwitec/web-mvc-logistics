...
_2a = _2c.data;
//add by lhs 2012-13-27 for show blank row 
if (_2d.showblank) {
    _2a.unshift(_2d.blankdefault);
}
//end add
...
$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
    ...
    //add by lhs 2013-11-27 for show blank row  
    showblank: false,
    blankdefault: { value: '', text: '== 请选择 ==' },
    //end add
    groupField: null, groupFormatter: function (_60) {
return _60;
