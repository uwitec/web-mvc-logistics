...
easyuifix.datagrid_afterCreateEditor(_11b, _11c, row);
_11f(_11b,_11c);
};
...
easyuifix.datagrid_beforeDestroyEditor(_121, _122, row);
...
var _18c = false;
_18c = easyuifix.datagrid_editors_checkboxVal(_18a, _18b);
if($(_18a).val()==_18b){
_18c=true;
}
