...
<Localization language="Belarusian" description="Беларускі" cultureName="be">
  <A_WebViewer>
    ...
    <PrintToPdf>Друкаваць у PDF</PrintToPdf>
    <PrintToXps>Друк ў XPS</PrintToXps>
    <PrintWithoutPreview>Друкаваць без прагляду</PrintWithoutPreview>
  ...
  <Adapters>
    ...
    <AdapterOleDbConnection>Дадзеныя з OleDb злучэнні</AdapterOleDbConnection>
  ...
  <ChartRibbon>
    ...
    <AxesXTopAxis>Верхняя вось X</AxesXTopAxis>
    <AxesYAxis>Вось Y</AxesYAxis>
    <AxesYRightAxis>Правая вось Y</AxesYRightAxis>
  ...
  <Cloud>
    ...
    <OperationDownload>Спампаваць з сервера</OperationDownload>
  ...
  <Database>
    ...
    <DatabaseOleDb>OleDB злучэнне</DatabaseOleDb>
  ...
  <DesignerFx>
    ...
    <PreviewAs>Папярэдні прагляд як {0}</PreviewAs>
  ...
  <Errors>
    ...
    <NameExists>Паўтаральнае імя кампанента '{0}'.  Імёны кампанентаў павінны быць унікальнымі і незалежнымі ад рэгістра.</NameExists>
  ...
  <Export>
    ...
    <ExportTypePpt2007File>Файлы Microsoft PowerPoint 2007/2013...</ExportTypePpt2007File>
    ...
    <ImageCutEdges>Абрэзаць боку</ImageCutEdges>
  ...
  <FileFilters>
    ...
    <JpegFiles>JPEG малюнак (*.jpeg)|*.jpeg</JpegFiles>
  ...
  <FormDatabaseEdit>
    ...
    <OleDbEdit>Змена OleDb злучэнні</OleDbEdit>
    <OleDbNew>Новае OleDb злучэнне</OleDbNew>
  ...
  <FormDesigner>
    ...
    <HtmlPreview>HTML папярэдні прагляд</HtmlPreview>
    ...
    <Preview>Папярэдні прагляд</Preview>
  ...
  <FormViewer>
    ...
    <Save>Захаваць</Save>
    <SendEMail>Адправіць па E-Mail...</SendEMail>
    <StatusBar>Статутная панэль</StatusBar>
    <Thumbnails>Эскізы</Thumbnails>
    <title>Папярэдні прагляд</title>
  ...
  <HelpComponents>
    ...
    <StiImage>Гэты кампанент выкарыстоўваецца для вываду малюнкаў. Ён падтрымлівае наступныя графічныя фарматы: BMP, JPG, JPEG, GIF, TIFF, PNG, ICO, WMF, EMF.</StiImage>
  ...
  <HelpDesigner>
    ...
    <MainMenu>Націсніце тут, каб убачыць спіс магчымых аперацый з справаздачай, у тым ліку аперацыі адкрыцця, закрыцця і папярэдняга прагляду.</MainMenu>
    ...
    <menuPreviewSettings>Выклікаць рэдактар вонкавага выгляду акна папярэдняга прагляду справаздачы. Налады будуць ужывацца толькі пры праглядзе справаздачы.</menuPreviewSettings>
    <menuPrint>Абраць друкарку, колькасць копій і іншыя параметры перад друкам.</menuPrint>
    <menuPrintPreview>Выканаць папярэдні прагляд справаздачы перад друкам.</menuPrintPreview>
    ...
    <ReportPreview>Папярэдні прагляд редагуемай справаздачы.</ReportPreview>
  ...
  <HelpViewer>
    ...
    <Close>Згарнуць закладку папярэдняга прагляду і вярнуцца да рэдагавання справаздачы.</Close>
    <CloseDotMatrix>Згарнуць закладку папярэдняга прагляду для матрычных прынтэраў і вярнуцца да рэдагавання справаздачы.</CloseDotMatrix>
    ...
    <SendEMail>Даслаць справаздачу па E-Mail.</SendEMail>
  ...
  <MainMenu>
    ...
    <menuFileRecentDocuments>Апошнiя справаздачы</menuFileRecentDocuments>
    ...
    <menuFileReportPreview>Папярэдні прагляд...</menuFileReportPreview>
  ...
  <PropertyEnum>
    ...
    <StiFormStartModeOnPreview>У папярэднім праглядзе</StiFormStartModeOnPreview>
    ...
    <StiSeriesYAxisLeftYAxis>Левая вось Y</StiSeriesYAxisLeftYAxis>
    <StiSeriesYAxisRightYAxis>Правая вось Y</StiSeriesYAxisRightYAxis>
    ...
    <StiSqlSourceTypeTable>Табліца</StiSqlSourceTypeTable>
  ...
  <PropertyMain>
    ...
    <PreviewMode>Рэжым папярэдняга прагляду</PreviewMode>
    <PreviewSettings>Налада папярэдняга прагляду</PreviewSettings>
    ...
    <ShowYAxis>Паказваць Y вось</ShowYAxis>
    ...
    <XAxis>Вось X</XAxis>
    <XTopAxis>X Вось Верхняя</XTopAxis>
    <YAxis>Вось Y</YAxis>
    <YRightAxis>Y Вось Правая</YRightAxis>
    <Zoom>Маштаб</Zoom>
  </PropertyMain>
  ...
  <Report>
    ...
    <CrossBands>Крос-секцыі</CrossBands>
    ...
    <ReportRenderingMessages>Паведамленні пабудовы справаздачы.</ReportRenderingMessages>
