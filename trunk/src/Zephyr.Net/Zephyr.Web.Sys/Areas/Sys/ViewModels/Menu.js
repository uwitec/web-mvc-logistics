...
function viewModel() {
    ...
    this.saveClick = function () {
        ...
        var changes = new com.editTreeGridViewModel(self.grid).getChanges(['_id', 'MenuName', 'MenuCode', 'ParentCode', 'IconClass', 'URL', 'IsVisible', 'IsEnable', 'MenuSeq']);
        if (self.grid.onClickRow() && changes._changed) {
            com.ajax({
