...
namespace Zephyr.Data
{
	internal class ActionsHandler
	{
		...
		{
            //modify by liuhuisheng 2013-11-13 start for handle columns and wheres have the same parameterName eg. update ID=1 where ID=2
			//var parameterName = columnName;
            var parameterName = "where_" + columnName;
            //modify by liuhuisheng 2013-11-13 end  
