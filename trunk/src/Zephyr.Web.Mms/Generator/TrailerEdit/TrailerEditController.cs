...
{
    public class TrailerEditController : Controller
    {
        public ActionResult Edit(string id = "")
        {
            ...
            {
                urls = new {
                    getdata = "/api/Trade/TrailerEdit/GetPageData/",        //获取主表数据及数据滚动数据api
                    edit = "/api/Trade/TrailerEdit/edit/",                      //数据保存api
                    audit = "/api/Trade/TrailerEdit/audit/",                    //审核api
                    newkey = "/api/Trade/TrailerEdit/GetNewRowId/"            //获取新的明细数据的主键(日语叫采番)
                },
                resx = new {
                    rejected = "已撤消修改！",
                    editSuccess = "保存成功！",
                ...
                dataSource = new{
                    pageData=new TrailerEditApiController().GetPageData(id)
    ...
    public class TrailerEditApiController : ApiController
    {
