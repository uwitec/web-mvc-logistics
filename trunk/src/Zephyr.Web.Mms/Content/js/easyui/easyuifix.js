...
easyuifix.easyloader_addLoadModules = function (modules) {
    $.extend(modules, {
        juidatepick: {
            js: "/Content/js/jquery-plugins/jquery-ui/js/jquery-ui-datepick.min.js",
            css: "/Content/js/jquery-plugins/jquery-ui/css/jquery-ui.css"
        },
        daterange: {
            js: "/Content/js/jquery-plugins/daterange/jquery.daterange.js",
            css: "/Content/js/jquery-plugins/daterange/jquery.daterange.css",
            dependencies: ["juidatepick"]
        },
        extend: {
            js: "/Content/js/easyui/easyuiext.js"
        },
        lookup: {
            js: "/Content/js/easyui/1.3.2/plugins/jquery.lookup.js",
            dependencies: ["combo"]
        },
        autocomplete: {
            js: "/Content/js/easyui/1.3.2/plugins/jquery.autocomplete.js",
            dependencies: ["combo"]
        }
    });
};
...
//for easyui 1.3.4 修正$._boxModel在jquery.parser.js中计算，但由于加载顺序有可能未计算，在easyloader中调用
easyuifix.check_boxModel = function () {
    if ($._boxModel == undefined) {
