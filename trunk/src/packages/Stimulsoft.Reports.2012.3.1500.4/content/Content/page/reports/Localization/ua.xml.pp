...
<Localization language="Ukrainian" description="Українська" cultureName="ua">
  <A_WebViewer>
    ...
    <PrintToPdf>Друкувати в PDF</PrintToPdf>
  ...
  <Adapters>
    ...
    <AdapterOleDbConnection>Дані з OleDb з'єднання</AdapterOleDbConnection>
  ...
  <Database>
    ...
    <DatabaseOleDb>OleDB з'єднання</DatabaseOleDb>
  ...
  <Errors>
    ...
    <NameExists>Повторюване ім'я компонента '{0}'.  Імена компонентів повинні бути унікальними й незалежними від регістра.</NameExists>
  ...
  <FileFilters>
    ...
    <JpegFiles>JPEG зображення (*.jpeg)|*.jpeg</JpegFiles>
    ...
    <Word2007Files>Файли Microsoft Word 2007/2013 (*.docx)|*.docx</Word2007Files>
  ...
  <FormDatabaseEdit>
    ...
    <OleDbEdit>Редагування OleDb з'єднання</OleDbEdit>
    <OleDbNew>Нове OleDb з'єднання</OleDbNew>
  ...
  <FormDesigner>
    ...
    <WebPreview>Web перегляд</WebPreview>
  </FormDesigner>
  ...
  <FormViewer>
    ...
    <Save>Зберегти</Save>
    <SendEMail>Відправити по E-Maіl...</SendEMail>
  ...
  <HelpViewer>
    ...
    <SendEMail>Надіслати звіт по e-mail.</SendEMail>
  ...
  <PropertyEnum>
    ...
    <StiReportCacheModeOff>Вкл</StiReportCacheModeOff>
    <StiReportCacheModeOn>Викл</StiReportCacheModeOn>
  ...
  <Report>
    ...
    <CrossBands>Крос-бенди</CrossBands>
    ...
    <ReportRenderingMessages>Повідомлення побудови звіту</ReportRenderingMessages>
