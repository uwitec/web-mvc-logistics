...
<Localization language="Portugese (Brazil)" description="Português (Brasil)" cultureName="pt-BR">
  <A_WebViewer>
  ...
  <Adapters>
    ...
    <AdapterCrossTabDataSource>Dados do CrossTab</AdapterCrossTabDataSource>
    ...
    <AdapterOleDbConnection>Dados de Conexão OleDb</AdapterOleDbConnection>
  ...
  <Chart>
    ...
    <AddSeries>Adicionar Séries</AddSeries>
    ...
    <FullStackedSpline>Spline Total-Empilhado</FullStackedSpline>
    <FullStackedSplineArea>Área de Spline Total-Empilhada</FullStackedSplineArea>
    <Funnel>Funil</Funnel>
    <Gantt>Gantt</Gantt>
    ...
    <Scatter>Se espalhe</Scatter>
    <ScatterLine>Se espalhe Linha</ScatterLine>
    <ScatterSpline>Se espalhe Spline</ScatterSpline>
    ...
    <SplineArea>Área de Spline</SplineArea>
    <SplineRange>Intervalo de Spline</SplineRange>
    ...
    <StackedSpline>Spline empilhado</StackedSpline>
    <StackedSplineArea>Área de Spline empilhada</StackedSplineArea>
  ...
  <ChartRibbon>
    ...
    <AxesLabel>Rotulo de Enquadramento</AxesLabel>
  ...
  <Components>
    ...
    <StiContainer>Recipiente</StiContainer>
    <StiContourText>Texto Contornado</StiContourText>
    <StiCrossColumn>Cross Coluna</StiCrossColumn>
    <StiCrossColumnTotal>Cross Coluna Total</StiCrossColumnTotal>
    ...
    <StiCrossRow>Cross Linha</StiCrossRow>
    <StiCrossRowTotal>Cross Linha Total</StiCrossRowTotal>
    <StiCrossSummary>Cross Resumo</StiCrossSummary>
    <StiCrossSummaryHeader>Cross-Summary Cabeçalho</StiCrossSummaryHeader>
    ...
    <StiGroupFooterBand>Rodapé Grupo</StiGroupFooterBand>
    <StiGroupHeaderBand>Cabeçalho Grupo</StiGroupHeaderBand>
    ...
    <StiOverlayBand>Revista</StiOverlayBand>
    <StiPage>Página</StiPage>
    <StiPageFooterBand>Rodapé Página</StiPageFooterBand>
    <StiPageHeaderBand>Cabeçalho Página</StiPageHeaderBand>
    <StiPanel>Painel</StiPanel>
    <StiRectanglePrimitive>Retângulo</StiRectanglePrimitive>
    <StiReport>Relatório</StiReport>
    <StiReportSummaryBand>Resumo Relatório</StiReportSummaryBand>
    <StiReportTitleBand>Título Relatório</StiReportTitleBand>
    ...
    <StiTextInCells>Texto nas Celas</StiTextInCells>
  ...
  <Database>
    ...
    <DatabaseOleDb>Conexão OLEDB</DatabaseOleDb>
...
sucedida</ConnectionSuccessfull>
  ...
  <Export>
    ...
    <AllBands>Todas as Bandas</AllBands>
    ...
    <BandsFilter>Filtro de Bandas:</BandsFilter>
    <Color>Cor</Color>
    ...
    <ExportTypeExcel2007File>Arquivo Microsoft Excel 2007/2013...</ExportTypeExcel2007File>
    ...
    <ExportTypePpt2007File>Arquivo Microsoft PowerPoint 2007/2013...</ExportTypePpt2007File>
    ...
    <ExportTypeWord2007File>Arquivo Microsoft Word 2007/2013...</ExportTypeWord2007File>
  ...
  <FileFilters>
    ...
    <JpegFiles>Arquivos de Imagem JPEG (*.jpeg)|*.jpeg</JpegFiles>
...
(*.{1})|*.{2}</LanguageForSilverlightFiles>
    ...
    <Word2007Files>Arquivos Microsoft Word 2007/2013 (*.docx)|*.docx</Word2007Files>
  ...
  <FormConditions>
    ...
    <ComponentIsEnabled>Componente é Habilitado</ComponentIsEnabled>
    <NoConditions>Nenhuma Condição</NoConditions>
  ...
  <FormDatabaseEdit>
    ...
    <OleDbEdit>Editar Conexão OleDb</OleDbEdit>
    <OleDbNew>Nova Conexão OleDb</OleDbNew>
  ...
  <FormDictionaryDesigner>
    ...
    <DataParameterEdit>Editar Parametro</DataParameterEdit>
    <DataParameterNew>Novo Parametro</DataParameterNew>
    ...
    <RetrieveColumns>Recobre Colunas</RetrieveColumns>
    ...
    <ViewData>Veja os Dados</ViewData>
  ...
  <FormFormatEditor>
    ...
    <GroupSize>Tamanho de Grupo:</GroupSize>
    ...
    <UseLocalSetting>Use Colocação Local</UseLocalSetting>
  </FormFormatEditor>
  ...
  <FormStyleDesigner>
    ...
    <CreateStyleCollection>Criar Coleção Estilo</CreateStyleCollection>
  ...
  <FormSystemTextEditor>
    ...
    <LabelSummaryFunction>Função de Somatória:</LabelSummaryFunction>
    <pageExpression>Expressão</pageExpression>
    <pageSummary>Somatória</pageSummary>
    <pageSystemVariable>Variavel de Sistema</pageSystemVariable>
  ...
  <FormTitles>
    ...
    <InteractionDrillDownPageSelectForm>Selecionar Berbequim-página</InteractionDrillDownPageSelectForm>
  ...
  <FormViewer>
    ...
    <Save>Salvar...</Save>
    <SendEMail>Envie E-mail...</SendEMail>
  ...
  <Gui>
    ...
    <cust_caption>Customizar</cust_caption>
    <cust_cbo_fade>Fade</cust_cbo_fade>
    <cust_cbo_none>(Nenhum)</cust_cbo_none>
    <cust_cbo_random>Randômico</cust_cbo_random>
  ...
  <HelpComponents>
    ...
    <StiChildBand>A banda Criança pode ser usado para saída de duas faixas em uma linha de dados.</StiChildBand>
    ...
    <StiColumnFooterBand>Esta faixa é usada para rodapés saída de colunas sobre a faixa de dados. A banda ColumnFooter é a saída, uma vez em cada coluna. Todos os componentes que são colocados sobre essa banda terá uma saída em cada coluna.</StiColumnFooterBand>
    <StiColumnHeaderBand>Esta faixa é usada para cabeçalhos de coluna. A banda ColumnHeader é usado para saída de uma única vez. Todos os componentes que são colocados sobre a banda podem ser reproduzidas em cada coluna.</StiColumnHeaderBand>
    <StiContainer>Esta é a região retangular onde outros componentes, incluindo bandas, pode ser colocado. Ao mover o recipiente em compinents será movido também. O recipiente pode ser colocado tanto em uma banda e em uma página.</StiContainer>
    <StiCrossDataBand>Esta banda é ligado à fonte de dados. É saída quantas vezes existem linhas na fonte de dados. Bandas Cruz estão de saída da esquerda para a direita.</StiCrossDataBand>
    <StiCrossFooterBand>Esta faixa é usada para rodapés saída de uma banda CrossData. A banda está de saída, uma vez depois de todas as linhas da faixa de dados. Bandas Cruz estão de saída da esquerda para a direita.</StiCrossFooterBand>
    <StiCrossGroupFooterBand>Esta faixa é usada para rodapés saída de um grupo. É colocado sob a banda CrossData. Cada CrossFooter pertence à banda CrossHeader especificado. Bandas Cruz aree saída da esquerda para a direita.</StiCrossGroupFooterBand>
    <StiCrossGroupHeaderBand>Esta banda é a base para a renderização de relatório com agrupamento, quando CrossData são utilizados. É impossível criar agrupamento sem esta banda. Os componentes para mostrar as informações do grupo são colocados no cabeçalho do grupo. A informação pode ser o nome do grupo, data, condição de agrupamento, etc A banda está de saída no início de cada grupo. Bandas Cruz estão de saída da esquerda para a direita.</StiCrossGroupHeaderBand>
    <StiCrossHeaderBand>Esta faixa é usada para cabeçalhos de saída. É utilizado em associação com a banda Cruz. Bandas Cruz estão de saída da esquerda para a direita.</StiCrossHeaderBand>
    <StiCrossTab>A componente guia é usada para a representação de dados estruturados como uma tabela.</StiCrossTab>
    <StiDataBand>Dados em banda The ligado à fonte de dados e é saída quantas vezes existem linhas na fonte de dados </StiDataBand>
    <StiEmptyBand>Esta faixa é usada para preencher o espaço livre no fundo de uma página. Esta banda preenche o espaço livre em cada página de um relatório.</StiEmptyBand>
    <StiFooterBand>Esta faixa é utilizada a ficha de saída da banda de dados. É colocado sob a banda de dados e é uma vez após a saída de todas as linhas de dados que gera banda de dados.</StiFooterBand>
    <StiGroupFooterBand>A banda RodapéDoGrupo é usado para a saída do rodapé de grupo. Esta faixa é colocada após a banda de dados. E esta é a banda de dados com o que a banda GroupHeader está vinculado. Cada banda RodapéDoGrupo pertence à banda GroupHeader especificado. A banda RodapéDoGrupo não será emitido sem a banda GroupHeader.</StiGroupFooterBand>
    <StiGroupHeaderBand>Esta banda é a banda de base para processamento de relatórios com agrupamento. Os componentes para mostrar as informações por este grupo são colocados no cabeçalho do grupo. Pode ser o nome do grupo, data, condição de agrupamento, etc Esta banda é de saída uma vez no início de cada grupo.</StiGroupHeaderBand>
    <StiHeaderBand>Esta faixa é usada para cabeçalhos de saída. É utilizado em conjunto com a banda de dados.</StiHeaderBand>
    <StiHierarchicalBand>Esta banda é ligado à fonte de dados e saída de quantas vezes existem linhas na fonte de dados. Os dados são de saída como uma árvore.</StiHierarchicalBand>
    ...
    <StiOverlayBand>Esta banda é usado para saída d'água em uma página.</StiOverlayBand>
    ...
    <StiPanel>É a região retangular, de que outros componentes, incluindo bandas, será colocado. Ao mover o painel, os componentes que estão movendo-se demasiado. O painel pode ser colocado tanto em uma banda ou em uma página.</StiPanel>
    ...
    <StiText>Este componente é objeto de base de dados de saída como um texto.</StiText>
  ...
  <HelpDesigner>
    ...
    <AlignLeft>Alinhar o conteúdo de um componente para a esquerda.</AlignLeft>
    <AlignMiddle>Center o conteúdo, os limites superior e inferior de um componente.</AlignMiddle>
    <AlignRight>Alinhar o conteúdo de um componente para a direita.</AlignRight>
    <AlignToGrid>Alinhar o selecionado componentes para nós de rede.</AlignToGrid>
    ...
    <menuViewShowHeaders>cabeçalhos Show de bandas.</menuViewShowHeaders>
    ...
    <StyleDesigner>Designer Style Executar.</StyleDesigner>
  ...
  <HelpViewer>
    ...
    <SendEMail>Enviar um relatório por e-mail.</SendEMail>
  ...
  <MainMenu>
    ...
    <menuEditDataParameterNew>Novo Parametro...</menuEditDataParameterNew>
    ...
    <menuEditVariableNew>Nova Variavel...</menuEditVariableNew>
  ...
  <PropertyCategory>
    <AppearanceCategory>Aparecimento</AppearanceCategory>
    ...
    <CrossTabCategory>Aba transversal</CrossTabCategory>
    ...
    <PageColumnBreakCategory>Pagina e Coluna Rompida</PageColumnBreakCategory>
  ...
  <PropertyEnum>
    ...
    <DataGridLineStyleSolid>Solido</DataGridLineStyleSolid>
    ...
    <StiColorScaleTypeColor2>2-Escala de cores</StiColorScaleTypeColor2>
    <StiColorScaleTypeColor3>3-Escala de cores</StiColorScaleTypeColor3>
    ...
    <StiDockStyleFill>Encher</StiDockStyleFill>
    <StiDockStyleLeft>A esquerda</StiDockStyleLeft>
    ...
    <StiFilterConditionEqualTo>iguale</StiFilterConditionEqualTo>
    <StiFilterConditionGreaterThan>maior então</StiFilterConditionGreaterThan>
    <StiFilterConditionGreaterThanOrEqualTo>maior então ou igual a</StiFilterConditionGreaterThanOrEqualTo>
    <StiFilterConditionLessThan>menos que</StiFilterConditionLessThan>
    <StiFilterConditionLessThanOrEqualTo>menos que ou igual a</StiFilterConditionLessThanOrEqualTo>
    ...
    <StiFilterConditionNotEqualTo>não igual para</StiFilterConditionNotEqualTo>
    ...
    <StiFilterDataTypeNumeric>Numerico</StiFilterDataTypeNumeric>
    <StiFilterDataTypeString>String</StiFilterDataTypeString>
    <StiFilterEngineReportEngine>Engine do Relatório</StiFilterEngineReportEngine>
    ...
    <StiFormStartModeOnStart>No Inicio</StiFormStartModeOnStart>
    <StiGroupSortDirectionAscending>Crecente</StiGroupSortDirectionAscending>
    <StiGroupSortDirectionDescending>Decrecente</StiGroupSortDirectionDescending>
    ...
    <StiKeepDetailsKeepDetailsTogether>Mantenha detalhes juntos</StiKeepDetailsKeepDetailsTogether>
    <StiKeepDetailsKeepFirstDetailTogether>Mantenha primeiro detalhe Juntos</StiKeepDetailsKeepFirstDetailTogether>
    <StiKeepDetailsKeepFirstRowTogether>Mantenha Primeira Linha Juntos</StiKeepDetailsKeepFirstRowTogether>
    ...
    <StiPrintOnEvenOddPagesTypePrintOnEvenPages>Imprimir em todas as paginas</StiPrintOnEvenOddPagesTypePrintOnEvenPages>
    <StiPrintOnEvenOddPagesTypePrintOnOddPages>Imprimir em paginas impares</StiPrintOnEvenOddPagesTypePrintOnOddPages>
  ...
  <PropertyEvents>
    ...
    <GetCrossValueEvent>Obter o Valor cross</GetCrossValueEvent>
    <GetCutPieListEvent>Obter Cortador Lista Pizza</GetCutPieListEvent>
    <GetDisplayCrossValueEvent>Exibição Valor cross</GetDisplayCrossValueEvent>
    <GetDrillDownReportEvent>Obter Broca - Abaixo Relatório</GetDrillDownReportEvent>
    <GetExcelSheetEvent>Começar a folha do Excel</GetExcelSheetEvent>
    <GetExcelValueEvent>Obter Superiorizar-se Valor</GetExcelValueEvent>
    <GetHyperlinkEvent>Adquira Hyperlink</GetHyperlinkEvent>
    <GetImageDataEvent>Obter Imagem Dados</GetImageDataEvent>
    <GetImageURLEvent>Adquira URL de Imagem</GetImageURLEvent>
    ...
    <GetToolTipEvent>Adquira Ajuda da Ferramenta</GetToolTipEvent>
  ...
  <PropertyMain>
    ...
    <AllowUseBackColor>Permitir Utilize Voltar Cor</AllowUseBackColor>
    ...
    <AllowUseForeColor>Permitir o uso ForeColor</AllowUseForeColor>
    ...
    <AlternatingBackColor>Cor do Fundo Alternativo</AlternatingBackColor>
    <Angle>Ângulo</Angle>
    ...
    <AspectRatio>Relação de aspecto</AspectRatio>
    <Author>Autor</Author>
    <Auto>Auto</Auto>
    ...
    <AutoRefresh>Auto Atualizar</AutoRefresh>
    <AutoRotate>Auto Rotação</AutoRotate>
    <AutoScale>Auto Escala</AutoScale>
    ...
    <AutoWidth>Auto Largura</AutoWidth>
    <AutoWidthType>Auto tipo da largura</AutoWidthType>
    <AxisValue>Valor Axis</AxisValue>
    <BackColor>Cor do Fundo</BackColor>
    <Background>Fundo</Background>
    <BackgroundColor>Cor do fundo</BackgroundColor>
    ...
    <BrushType>Tipo Pincel</BrushType>
    <BusinessObject>Objeto do negócio</BusinessObject>
    <CacheAllData>Cache Todos os Dados</CacheAllData>
    ...
    <CellDockStyle>Estilo Doca celular</CellDockStyle>
    <CellHeight>Altura de cela</CellHeight>
    <CellType>verifique soma</CellType>
    <CellWidth>Largura de cela</CellWidth>
    <ChartType>Tipo de Gráficos</ChartType>
    <Checked>Selecionado</Checked>
    <CheckOnClick>Selecionado com Click</CheckOnClick>
    <CheckStyle>Estilo do Selecionado</CheckStyle>
    <CheckStyleForFalse>Marcar Estilo para Falso</CheckStyleForFalse>
    <CheckStyleForTrue>Marcar Estilo para Verdadeiro</CheckStyleForTrue>
    ...
    <CollapsingEnabled>Recolimento Ativado</CollapsingEnabled>
    <Collate>Colecione</Collate>
    <CollectionName>Nome da coleção</CollectionName>
    <Color>Cor</Color>
    <ColorEach>Colorir cada Um</ColorEach>
    <ColorScaleCondition>Cor Condição Escala</ColorScaleCondition>
    ...
    <ColumnGaps>Aberturas da coluna</ColumnGaps>
    ...
    <DataBarCondition>Dados Condição Bar</DataBarCondition>
    ...
    <Dock>Ligar</Dock>
    <DockableTable>Tabela de Dockable</DockableTable>
    ...
    <DrillDownEnabled>Broca - Abaixo Ativado</DrillDownEnabled>
    <DrillDownPage>Broca - Abaixo Página</DrillDownPage>
    <DrillDownParameter1>Broca - Abaixo Parâmetro 1</DrillDownParameter1>
    <DrillDownParameter2>Broca - Abaixo Parâmetro 2</DrillDownParameter2>
    <DrillDownParameter3>Broca - Abaixo Parâmetro 3</DrillDownParameter3>
    ...
    <DrillDownReport>Broca - Abaixo Relatório</DrillDownReport>
    <DropDownAlign>Drop Down Alinhamento</DropDownAlign>
    <DropDownStyle>Drop Down Estilo</DropDownStyle>
    <DropDownWidth>Drop Down Largura</DropDownWidth>
    <DropShadow>Drop Sombra</DropShadow>
    <Duplex>Duplo</Duplex>
    <Editable>Editar Tabela</Editable>
    ...
    <EvenStyle>Mesmo Estilo</EvenStyle>
    ...
    <FieldIs>Campo É</FieldIs>
    <File>Arquivo</File>
    <Fill>Preencher</Fill>
    <Filter>Filtrar</Filter>
    <FilterEngine>Engine de Filtro</FilterEngine>
    <FilterOn>Filtrar em</FilterOn>
    ...
    <FooterCanBreak>Rodapé pode quebrar</FooterCanBreak>
    <FooterCanGrow>Rodapé pode crescer</FooterCanGrow>
    <FooterCanShrink>O Rodapé de página pode encolher</FooterCanShrink>
    <FooterPrintAtBottom>Imprimir o Rodapé de página na parte inferior</FooterPrintAtBottom>
    <FooterPrintIfEmpty>Imprimir do Rodapé de página se vazio</FooterPrintIfEmpty>
    <FooterPrintOn>Imprimir do Rodapé de página sobre</FooterPrintOn>
    <FooterPrintOnAllPages>Imprimir Rodapé em todas as páginas</FooterPrintOnAllPages>
    <FooterPrintOnEvenOddPages>Imprimir Rodapé mesmo em páginas impares</FooterPrintOnEvenOddPages>
    ...
    <HeaderPrintOnEvenOddPages>Imprimir Cabeçalho mesmo em páginas impares</HeaderPrintOnEvenOddPages>
    ...
    <Icon>Icone</Icon>
    <IconSet>Definir Ícone</IconSet>
    <IconSetCondition>Definir Condição do Icone</IconSetCondition>
    ...
    <ImageHorAlignment>Imagem Alinhamento Horizontal</ImageHorAlignment>
    <ImageMultipleFactor>Imagem do Fator Múltiplo</ImageMultipleFactor>
    <ImageRotation>Rotação Imagem</ImageRotation>
    <ImageStretch>Extensão da imagem</ImageStretch>
    <ImageTiling>Telha de imagem</ImageTiling>
    <ImageTransparency>Imagem Transparente</ImageTransparency>
    ...
    <Items>Ítens</Items>
    <KeepChildTogether>Mantenha Filho Junto</KeepChildTogether>
    <KeepCrossTabTogether>Mantenha Cross-Tab Juntos</KeepCrossTabTogether>
    <KeepDetails>Mantenha Detalhes</KeepDetails>
    <KeepDetailsTogether>Mantenha detalhes juntamente</KeepDetailsTogether>
    <KeepFooterTogether>Mantenha Rodapé Junto</KeepFooterTogether>
    <KeepGroupFooterTogether>Manter grupo de rodapé, juntamente</KeepGroupFooterTogether>
    <KeepGroupHeaderTogether>Manter grupo cabeçalho juntamente </KeepGroupHeaderTogether>
    <KeepGroupTogether>Mantenha Grupo Junto</KeepGroupTogether>
    <KeepHeaderTogether>Mantenha Cabeçalho Junto</KeepHeaderTogether>
    <KeepReportSummaryTogether>Manter Relatório Síntese, juntamente</KeepReportSummaryTogether>
    <KeepSubReportTogether>Mantenha Sub-relatório, juntamente</KeepSubReportTogether>
    <Key>Chave</Key>
    ...
    <LargeHeight>Altura da grande</LargeHeight>
    <LargeHeightFactor>Fator de Altura da grande</LargeHeightFactor>
    <Left>Esquerda</Left>
    ...
    <LineLimit>Limite de linhas</LineLimit>
    <LineMarker>Linha Marcador</LineMarker>
    ...
    <ListOfToolTips>Lista de Tool Tips</ListOfToolTips>
    ...
    <OddStyle>Estilo Diferente</OddStyle>
    ...
    <Parameters>Parâmetros</Parameters>
    <ParametersOrientation>Orientação Parametros</ParametersOrientation>
    ...
    <PrintAtBottom>Imprimir no Fundo</PrintAtBottom>
    <PrinterName>Nome da Impressora</PrinterName>
    <PrinterSettings>Configuração da impressora</PrinterSettings>
    <PrintHeadersFootersFromPreviousPage>Imprima Cabeçalhos e rodapés de Página de Pré-Visualização</PrintHeadersFootersFromPreviousPage>
    ...
    <PrintOn>Imprima Em</PrintOn>
    <PrintOnAllPages>Imprimir em Todas as Páginas</PrintOnAllPages>
    <PrintOnEvenOddPages>Imprimir em Paginas Impares</PrintOnEvenOddPages>
    <PrintOnPreviousPage>Imprimir a Página de Visualização</PrintOnPreviousPage>
    <PrintTitleOnAllPages>Imprimir Título Em todas as páginas</PrintTitleOnAllPages>
    <PrintVerticalBars>Imprimir As barras verticais</PrintVerticalBars>
    <ProcessAt>Processo em</ProcessAt>
    <ProcessAtEnd>Processar até o Fim</ProcessAtEnd>
    <ProcessingDuplicates>Processando Duplicação</ProcessingDuplicates>
    ...
    <RequestFromUser>Pedido do usuário</RequestFromUser>
    <RequestParameters>Pedido Parâmetros</RequestParameters>
    <ResetDataSource>Reajusta Fonte de Dados</ResetDataSource>
    <ResetPageNumber>Reajustar Número de Página</ResetPageNumber>
    ...
    <RightToLeft>Direita para Esquerada</RightToLeft>
    ...
    <Shift>Troca</Shift>
    <ShiftMode>Trocar Modo</ShiftMode>
    <ShowBehind>Mostre Atrás</ShowBehind>
    <ShowDialog>Diálogo da Visualização</ShowDialog>
    <ShowEdgeValues>Mostrar valores da borda</ShowEdgeValues>
    <ShowImageBehind>Mostrar Imagem Atrás</ShowImageBehind>
    <ShowInLegend>Mostre em Lengenda</ShowInLegend>
    <ShowInPercent>Mostrar Percentual</ShowInPercent>
    <ShowLabels>Mostrar Rotulos</ShowLabels>
    <ShowLabelText>Texto de Rótulo da Visualização</ShowLabelText>
    ...
    <SkipFirst>Passar Primeira</SkipFirst>
    <Smoothing>Ajustando</Smoothing>
    <Sort>Ordem</Sort>
    <SortBy>Ordene por</SortBy>
    <SortDirection>Direção da Ordem</SortDirection>
    <Sorted>Ordenado</Sorted>
    <SortingColumn>Classificando Coluna</SortingColumn>
    <SortingEnabled>Ativado Classificando</SortingEnabled>
    <SortType>Tipo de Ordem</SortType>
    <Space>Spaço</Space>
    <Spacing>Espaçando</Spacing>
    <SqlCommand>Comando SQL</SqlCommand>
    <StartAngle>Angulo Inicial</StartAngle>
    <StartCap>Inicio da Cap</StartCap>
    <StartColor>Cor de Início</StartColor>
    <StartFromZero>Comece Do Zero</StartFromZero>
    <StartMode>Iniciar modalidade</StartMode>
    ...
    <Step>Passo</Step>
    <Stop>Parar</Stop>
    <StopBeforePage>Pare Antes da Página</StopBeforePage>
    <StopBeforePrint>Pare Antes da Impressão</StopBeforePrint>
    <StoreImagesInResources>Armazene imagens nos recursos</StoreImagesInResources>
    ...
    <TextBrush>Preenchimento de Texto</TextBrush>
    ...
    <To>Para</To>
    <Today>Hoje</Today>
    <ToolTip>Ajuda da Ferramenta</ToolTip>
    <ToolTipDataColumn>Coluna de Informações de Tool Tip</ToolTipDataColumn>
    <Top>Topo</Top>
    ...
    <WordWrap>Multiplas Linhas</WordWrap>
    <Wrap>Envoltório</Wrap>
    <WrapGap>Envoltório Gap</WrapGap>
    <XAxis>X eixo</XAxis>
    <XTopAxis>X Topo eixo</XTopAxis>
    <YAxis>Y Eixo</YAxis>
    <YRightAxis>Y Direita Eixo</YRightAxis>
    <Zoom>Zoom</Zoom>
  </PropertyMain>
  ...
  <QueryBuilder>
    ...
    <ProcedureParameters>Parametros Procedimentos</ProcedureParameters>
    ...
    <QueryParameters>Parametros da Query</QueryParameters>
...
contexto do painel de propriedades.</qnConfiguration>
  ...
  <Report>
    ...
    <CrossBands>Faixa de Cruzamento</CrossBands>
    ...
    <LabelCountData>Contar Dados:</LabelCountData>
    ...
    <LabelFactorLevel>Fator aninhada:</LabelFactorLevel>
    ...
    <StiSolidBrush>Solido</StiSolidBrush>
  ...
  <Toolbars>
    ...
    <Link>Link</Link>
    <Lock>Travar</Lock>
    <MakeHorizontalSpacingEqual>Fazer Espaçamento Horizontal Igualar-se</MakeHorizontalSpacingEqual>
    ...
    <MakeVerticalSpacingEqual>Fazer o Espaçamento Vertical Igualar-se</MakeVerticalSpacingEqual>
    ...
    <ToolbarPageSetup>Configuração de Página</ToolbarPageSetup>
    ...
    <ToolbarWatermarkImage>Imagem d'água</ToolbarWatermarkImage>
    <ToolbarWatermarkText>Texto d'água</ToolbarWatermarkText>
  </Toolbars>
  <Toolbox>
    <Create>Criação de Componentes</Create>
    <Hand>Mão</Hand>
    <Select>Seleciona</Select>
    <Style>Cópia de Estilo</Style>
  ...
  <Wizards>
    ...
    <LabelReport>Rotulo do Relatório</LabelReport>
    <LabelSettings>Colocações do Rotulo</LabelSettings>
    ...
    <Preview>Pré-estréia</Preview>
    <Reset>&amp;Restauração</Reset>
